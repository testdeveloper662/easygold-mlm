...
//       }
//     }
//     console.log("[BrokerRegistration] Language - lang:", lang, "language:", languageParam, "using:", langForApi, "-> Mapped to:", languageForApi);

//     console.log("==================REGISTERING USER LOCALLY (external API bypassed)==============");

//     // ✅ Native Node registration (replaces the old axios call to `${EASY_GOLD_URL}/api/Register`)
...
//       purpose_of_business_relationship_check,
//       businesspurposeother,
//       internationalTrade: u_export_import,
//       thirdPartyTransactions,
//       beneficialOwners,
//       beneficialOwnersDetails,
//       monthlyVolume,
//       investigationProceedings,
//       language: languageForApi,
//       u_date: idExpiryDate || new Date().toISOString().split("T")[0],
//       veriff_session_id: veriffId,
//       files: req.files,
//       role_id: 2,
//     });

//     const apiResponse = { data: registrationResult };
