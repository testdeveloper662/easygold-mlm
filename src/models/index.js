...
const AdminFixedCustomerCommission = require("./adminFixedCustomerCommission");
...
const AffiliateBankDetails = require("./affiliate_bank_details");
const AffiliatePayoutRequests = require("./affiliate_payout_requests");
...
const TermsAndCondition = require("./termsAndConditions");
...
db.AdminFixedCustomerCommission = AdminFixedCustomerCommission;
...
db.AffiliateBankDetails = AffiliateBankDetails;
db.AffiliatePayoutRequests = AffiliatePayoutRequests;
...
db.TermsAndCondition = TermsAndCondition;
